...
\begin{document}	
	...
	\begin{frame}{Requirements for Firefighting}
		\begin{itemize}
			...
			\item Lightweight % Should not impact movement
			\item Wireless data transmission % For leadership outside
		...
		\begin{columns}
			\column{0.5\textwidth}
				\begin{itemize}
					...
					\item Next step: Tests in a firefighting environment (for example in a training container)
