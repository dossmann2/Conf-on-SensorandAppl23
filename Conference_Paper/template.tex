...
The test results show that by adding a secondary sensor a higher accuracy can be achieved compared to a system relying only with step-detection. To improve this design for firefighting application, a tracking camera working in near zero visibility environments has to be developed. By using multiple IMUs the accuracy could be further improved.
